    ...
    <div class="tut_001_container scale-container">
        <section class="tut_001_second_section">
            ...
            <div class="tut_001_cards_container">
                ...
                <div class="tut_001_card appearance-effect">
                    <img src="/modules/core/src/img/pl2.png" alt="Плашка 2" class="tut_001_card_image">
                    <div class="tut_001_card_overlay">
                        <div class="tut_001_card_content">
                ...
                <div class="tut_001_card appearance-effect">
                    <img src="/modules/core/src/img/pl1.png" alt="Плашка 3" class="tut_001_card_image">
                    <div class="tut_001_card_overlay">
                        <div class="tut_001_card_content">
                ...
                <div class="tut_001_card appearance-effect">
                    <img src="/modules/core/src/img/pl1.png" alt="Плашка 4" class="tut_001_card_image">
                    <div class="tut_001_card_overlay">
                        <div class="tut_001_card_content">
